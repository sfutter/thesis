...
df4 = df4 %>% select(Date, MMYYYY, Year, Month, Week, Day, TimeHoursNum,NO:WSPD)
dim(df4) # 78912 x 21
names(df4)
head(df4)
```
...
df12 = calculateMonthlyAverage(df11, 'NO2')
...
df13 = getDiffFromMeanMonthlyConcentration(df12, 'NO2'     ) # calculate diff in hourly values from max value for each Date in df
