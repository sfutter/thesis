...
getSlopeFrom5To8amByDate = function(df, predictor, startTime, endTime){
  ...
  slopeColName = (dfTemp[,tempColName2] - dfTemp[,tempColName1])/4     # 8am concentration minus 5am concentration /4 (since 4 hours imbetween)
...
df8 = getSlopeFrom5To8amByDate(df7, 'NO2'     , 5, 8)
...
# 4f?. for each date we need the average of the prior 1,2,3,4,5,6,7 days?? --- is this linked to NO2 level on a specific day, or the likelihood that it will go above a certain level
