...
test = -train
  ...
  for (i in 1:1){
    ...
    nodes_layer1 = ceiling(colcount/2)
...
dfExportResultsNO2 = data.frame(chosenVar, mae.train.latest, mae.test.latest, mae.xval.latest, 1)
write.csv(dfExportResultsNO2, file.path(outfilePath,'dfExportResultsNO2.csv')) 
