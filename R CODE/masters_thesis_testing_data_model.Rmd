...
#nodeCount = c(13) #ceiling(colcount/2),5,10) #search on
response        = c('NO2') 
...
# save the 'best' model
model_path  <- paste0("~/Dropbox/NU/THESIS_MAC/thesis/MODELS/",response[1],".dl.","hidden.layers.",nodes_layer1,"colcount.",i) 
