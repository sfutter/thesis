...
# #dfExportResults2 = dfExportResults2[,-1]  # remove the 'j'!!
# 
# 
# 
# # at this point we have a table of values that we can use, but need to select the one var that minimizes the mae.xval
...
# new values
# 	chosenVar.final.y	                                                 mae.train.latest.final	mae.test.latest.final	mae.xval.latest.final
# 1	lag.1.NO2, lag.2.NO2, X5amTo8amSlope.NOX.IMP, TimeHoursNum, RHUM	3.626987236	3.924647802	3.737961677



# 1 --> output from model when 1 layer of ceiling(0.5 * input cols) as number of hidden nodes
# 2 --> output from model when 1 layer of 10 hidden nodes
```
