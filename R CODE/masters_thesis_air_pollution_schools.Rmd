...
df = createDataFrame(df, responseCol)     # lags 1-3, current hour meteo, slopes for prior 8am.
...
# Export the data prediction for the testing and validation data sets
outfilePath  = file.path("~/Dropbox","NU","THESIS","DATASETS","RESULTS", "PREDICTIONS","ONE_HOUR_AHEAD_PREDICTIONS")
filenameTest = paste0('greenwich_eltham_',response[i],'_ann_test_5_hr_ahead_reset_13.csv')
filenameVali = paste0('greenwich_eltham_',response[i],'_ann_vali_5_hr_ahead_reset_13.csv')
...
lagPredictor      = paste0('lag.1.',response[i])
filenameInputVar1  = paste0('greenwich_eltham_',response[i],'_ann_test_5_hr_ahead_reset_13.csv')                          # 5 hr ahead is 1PM prediction taken at 12AM
df.test = updateDF_tMinus1Lags(df.test, lagPredictor, filenameInputVar1)

# repeat for vali set
filenameInputVar1  = paste0('greenwich_eltham_',response[i],'_ann_vali_5_hr_ahead_reset_13.csv')                          # 5 hr ahead is 1PM prediction taken at 12AM
df.vali = updateDF_tMinus1Lags(df.vali, lagPredictor, filenameInputVar1)
...
# Export the data prediction for the testing and validation data sets
outfilePath  = file.path("~/Dropbox","NU","THESIS","DATASETS","RESULTS", "PREDICTIONS","ONE_HOUR_AHEAD_PREDICTIONS")
filenameTest = paste0('greenwich_eltham_',response[i],'_ann_test_6_hr_ahead_reset_13.csv')
filenameVali = paste0('greenwich_eltham_',response[i],'_ann_vali_6_hr_ahead_reset_13.csv')
...
lagPredictor      = paste0('lag.1.',response[i])
filenameInputVar1  = paste0('greenwich_eltham_',response[i],'_ann_test_6_hr_ahead_reset_13.csv')                          # 6 hr ahead is 2PM prediction taken at 12AM
df.test = updateDF_tMinus1Lags(df.test, lagPredictor, filenameInputVar1)

filenameInputVar1  = paste0('greenwich_eltham_',response[i],'_ann_vali_6_hr_ahead_reset_13.csv')                          # 6 hr ahead is 2PM prediction taken at 12AM
df.vali = updateDF_tMinus1Lags(df.vali, lagPredictor, filenameInputVar1)

# 2-HOUR LAG IS 1PM PREDICTION
lagPredictor      = paste0('lag.2.',response[i])
filenameInputVar2  = paste0('greenwich_eltham_',response[i],'_ann_test_5_hr_ahead_reset_13.csv')                          # 5 hr ahead is 1PM prediction taken at 12AM
df.test = updateDF_tMinus2Lags(df.test, lagPredictor, filenameInputVar2)

filenameInputVar2  = paste0('greenwich_eltham_',response[i],'_ann_vali_5_hr_ahead_reset_13.csv')                          # 5 hr ahead is 1PM prediction taken at 12AM
df.vali = updateDF_tMinus2Lags(df.vali, lagPredictor, filenameInputVar2)
...
# Export the data prediction for the testing and validation data sets
outfilePath  = file.path("~/Dropbox","NU","THESIS","DATASETS","RESULTS", "PREDICTIONS","ONE_HOUR_AHEAD_PREDICTIONS")
filenameTest = paste0('greenwich_eltham_',response[i],'_ann_test_7_hr_ahead_reset_13.csv')
filenameVali = paste0('greenwich_eltham_',response[i],'_ann_vali_7_hr_ahead_reset_13.csv')
...
lagPredictor      = paste0('lag.1.',response[i])
filenameInputVar1  = paste0('greenwich_eltham_',response[i],'_ann_test_7_hr_ahead_reset_13.csv')                          # 7 hr ahead is 3PM prediction taken at 12AM
df.test = updateDF_tMinus1Lags(df.test, lagPredictor, filenameInputVar1)

filenameInputVar1  = paste0('greenwich_eltham_',response[i],'_ann_vali_7_hr_ahead_reset_13.csv')                          # 7 hr ahead is 2PM prediction taken at 12AM
df.vali = updateDF_tMinus1Lags(df.vali, lagPredictor, filenameInputVar1)


# 2-HOUR LAG IS 2PM PREDICTION
lagPredictor      = paste0('lag.2.',response[i])
filenameInputVar2  = paste0('greenwich_eltham_',response[i],'_ann_test_6_hr_ahead_reset_13.csv')                          # 6 hr ahead is 2PM prediction taken at 12AM
df.test = updateDF_tMinus2Lags(df.test, lagPredictor, filenameInputVar2)

filenameInputVar2  = paste0('greenwich_eltham_',response[i],'_ann_vali_6_hr_ahead_reset_13.csv')                          # 6 hr ahead is 2PM prediction taken at 12AM
df.vali = updateDF_tMinus2Lags(df.vali, lagPredictor, filenameInputVar2)


# 3-HOUR LAG IS 1PM PREDICTION
lagPredictor      = paste0('lag.3.',response[i])
filenameInputVar3  = paste0('greenwich_eltham_',response[i],'_ann_test_5_hr_ahead_reset_13.csv')                          # 5 hr ahead is 2PM prediction taken at 12AM
df.test = updateDF_tMinus3Lags(df.test, lagPredictor, filenameInputVar3)

filenameInputVar3  = paste0('greenwich_eltham_',response[i],'_ann_vali_5_hr_ahead_reset_13.csv')                          # 5 hr ahead is 2PM prediction taken at 12AM
df.vali = updateDF_tMinus3Lags(df.vali, lagPredictor, filenameInputVar3)
...
# Export the data prediction for the testing and validation data sets
outfilePath  = file.path("~/Dropbox","NU","THESIS","DATASETS","RESULTS", "PREDICTIONS","ONE_HOUR_AHEAD_PREDICTIONS")
filenameTest = paste0('greenwich_eltham_',response[i],'_ann_test_8_hr_ahead_reset_13.csv')
filenameVali = paste0('greenwich_eltham_',response[i],'_ann_vali_8_hr_ahead_reset_13.csv')
